...
import (
	...
	"github.com/Rich-Wilkyness/bookings/internal/repository"
	"github.com/Rich-Wilkyness/bookings/internal/repository/dbrepo"
)
...
// first) our attributes need to be capital so they are accessible.
// Second) we have to declare what we want the json to look like
...
func (m *Repository) AvailabilityJSON(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		...
		out, _ := json.MarshalIndent(resp, "", "     ") // generates the json from our passed in object, indent is just formatting
		w.Header().Set("Content-Type", "application/json")
		w.Write(out)
		return
	}
...
func (m *Repository) ReservationSummary(w http.ResponseWriter, r *http.Request) {
	// the .(models.Reservation) comes from us Registering the type on our main. This is asserting what type we are expecting to get from our Session
